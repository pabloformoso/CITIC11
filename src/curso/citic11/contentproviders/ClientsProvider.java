...
public class ClientsProvider extends ContentProvider {
	...
	// Content URI
	private static final String uri = "content://curso.citic/clients";
	...
	static {
		...
		uriMatcher.addURI("curso.citic", "clientes", CLIENTS);
		uriMatcher.addURI("curso.citic", "clientes/#", CLIENTS_ID);
	}	
	...
	public String getType(Uri uri) {
		...
		switch (match)  {
			case CLIENTS: 
				return "vnd.android.cursor.dir/vnd.citic.client";
			case CLIENTS_ID: 
				return "vnd.android.cursor.item/vnd.citic.client";
			default: 
				return null;
		}
	}
